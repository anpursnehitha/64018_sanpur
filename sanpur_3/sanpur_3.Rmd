...
#set inequality constraints in the form of matrix
...
#set right hand side constants
f.rhs <- c(750,900,450,13000,12000,5000,900,1200,750)

#The objective function of the given problem is:

lp("max",f.obj, f.con, f.dir, f.rhs)

#variables for L1,M1,S1,L2,M2,S2,L3,M3,S3
